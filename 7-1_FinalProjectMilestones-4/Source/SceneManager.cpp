...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 10.0f, 1.0f, 10.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", -10.0f, 1.0f, 10.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 10.6f, 1.0f, 10.0f);
...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("./candle_lid_texture.jpg", "lid");

	bReturn = CreateGLTexture("./candle_texture.jpg", "candle");

	bReturn = CreateGLTexture("./cylinder_modem_texture.jpg", "modem");

	bReturn = CreateGLTexture("./rusticwood.jpg", "desk");

	bReturn = CreateGLTexture("./router_texture.jpg", "router");

	bReturn = CreateGLTexture("./Screensaver_texture.jpg", "screensave1");

	bReturn = CreateGLTexture("./stainedglass.jpg", "screen");

	bReturn = CreateGLTexture("./sphere_texture.jpg", "sphere");
...
void SceneManager::RenderScene()
{
	...
	/****************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(6.0f, 4.0f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.0f, 6.0f, 2.0f);
	...
	//Lid for the candle
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, .2f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-10.0f, 1.0f, 0.0f);
	...
	m_basicMeshes->DrawCylinderMesh();
	/****************************************************************/
	//Stand for Extra Monitor
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.2f, 2.0f, 1.0f);
	...
	SetTransformations(
		...
		positionXYZ);
	// set the color values into the shader
	SetShaderColor(0.7, 1, 0.3, 1);
	SetShaderMaterial("glass");
	SetShaderTexture("modem");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.5f, 3.0f, 0.0f);
	...
	/****************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.5f, 1.5f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.5f, 2.0f, 7.5f);
